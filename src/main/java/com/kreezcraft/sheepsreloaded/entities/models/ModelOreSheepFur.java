...
public class ModelOreSheepFur extends ModelQuadruped {
    private float headRotationAngleX;

    public ModelOreSheepFur()
    {
        super(12, 0.0F);
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime)
    {
        ...
        this.head.rotationPointY = 6.0F + ((EntityOreSheep)entitylivingbaseIn).getHeadRotationPointY(partialTickTime) * 9.0F;
        this.headRotationAngleX = ((EntityOreSheep)entitylivingbaseIn).getHeadRotationAngleX(partialTickTime);
    }
